          ...
          <div className="modal-content">
            ...
            <div className="modal-body">
              <div className="text-center mb-3">
                <span
                  className="user-role-badge mb-2 d-inline-flex"
                  style={{
                    color: currentRoleCfg.color,
                    background: currentRoleCfg.bg,
                  }}
                >
          ...
          <div className="modal-content">
            <div className="modal-body text-center py-4">
              <div
                ...
                style={{
                  background: isBanning ? "#fef2f2" : "#e6f9f0",
                  color: isBanning ? "#e24b4a" : "#1a9e5c",
                }}
              >
                {isBanning ? <FaBan /> : <FaUnlock />}
              </div>
              <h5 className="delete-title mt-3">
                {isBanning ? "Ban User?" : "Unban User?"}
              </h5>
              <p className="delete-desc">
                {isBanning
                  ? "Are you sure you want to ban this user?"
                  : "Are you sure you want to restore access to this user?"}
                <br />
                <strong>
                  {u.firstName} {u.lastName}
                </strong>
            ...
            <div className="modal-footer justify-content-center gap-2 border-0 pt-0 pb-4">
              ...
              <button
                className={`btn px-4 ${isBanning ? "btn-danger" : "btn-success"}`}
                onClick={() => onConfirm(u)}
                disabled={saving}
              >
                {saving
        ...
        <div className="modal-dialog modal-dialog-centered">
          <div className="modal-content">
            ...
            <div className="modal-body">
              <div className="user-view-header">
                ...
                <div>
                  ...
                  <div className="d-flex align-items-center gap-2 mt-1">
                    ...
                    <span
                      className={`user-status-badge ${u.isActive ? "st-active" : "st-banned"}`}
                    >
              ...
              <div className="row g-3 mt-4">
                ...
                <div className="col-6">
                  ...
                  <div
                    className="p-2 border rounded bg-light text-truncate"
                    title={u.id}
                  >
                    <small>{u.id}</small>
                  </div>
                ...
                <div className="col-6">
                  ...
                  <div className="p-2 border rounded bg-light text-capitalize">
                    {u.provider || "Local"}
                  </div>
                </div>
                  ...
                  <div className="p-2 border rounded bg-light">
                    {u.isEmailVerified ? (
                      <span className="text-success">
                        <FaUserCheck className="me-1" /> Yes
                      </span>
                    ) : (
            ...
            <div className="modal-footer border-0">
              <button className="btn btn-light border w-100" onClick={onClose}>
                Close
              </button>
            </div>
          </div>
...
export default function AdminUsersPage() {
  ...
  const handleSaveRole = async (userId, newRole) => {
    ...
    try {
      ...
      alert(
        err?.response?.data?.message || "Failed to update role. See console.",
      );
    } finally {
      setSaving(false);
    }
    ...
    try {
      ...
      alert(
        err?.response?.data?.message ||
          "Failed to change user ban status. See console.",
      );
    } finally {
      setSaving(false);
    }
  ...
  return (
    <div className="admin-users">
      ...
      {/* List */}
      <div
        className="users-list position-relative"
      ...
      >
        ...
        {!loading && users.length === 0 ? (
          <div className="users-empty py-5 text-center text-muted">
            <FaUser
              className="users-empty__icon mb-3"
