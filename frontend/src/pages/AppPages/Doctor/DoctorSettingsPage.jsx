      ...
      <div className="profile-avatar-row">
        <div className="profile-avatar">
          <img
            ...
            onError={(e) => {
              e.target.src =
                "https://ui-avatars.com/api/?name=Dr+An&background=0ba3a3&color=fff";
            }}
          />
...
function ScheduleSection() {
  ...
  return (
    <div className="settings-content">
      ...
      <p className="settings-content__sub">
        Configure your working hours and appointment slots.
      </p>
        ...
        <div className="settings-form__group settings-form__group--full">
          ...
          <div className="day-checkboxes">
            {DAYS.map((day) => (
              <label
                key={day}
                className={`day-checkbox ${workingDays[day] ? "day-checkbox--checked" : ""}`}
              >
                <input
                  type="checkbox"
        ...
        <div className="settings-form__group settings-form__group--full">
          ...
          <div className="radio-group">
            {["30", "45", "60"].map((val) => (
              <label
                key={val}
                className={`radio-option ${form.slotDuration === val ? "radio-option--checked" : ""}`}
              >
                <input
                  type="radio"
                  name="slotDuration"
...
const defaultPrivacy = [
  {
    key: "profile_vis",
    label: "Profile Visibility to Patients",
    sub: "Allow patients to find and view your profile",
    on: true,
  },
  {
    key: "show_fee",
    label: "Show Consultation Fee Publicly",
    sub: "Display your fee on the public listing",
    on: true,
  },
  {
    key: "allow_reviews",
    label: "Allow Patient Reviews",
    sub: "Let patients leave ratings and feedback",
    on: true,
  },
  {
    key: "2fa",
  ...
  },
  {
    ...
    sub: "Contribute anonymized data for medical research",
    on: false,
  },
];
...
function PrivacySection() {
  ...
  return (
    <div className="settings-content">
      ...
      <p className="settings-content__sub">
        Control your visibility and account security settings.
      </p>
      <div className="notif-list">
    ...
    <div className="settings-page">
      ...
      <div className="settings-page__header">
        ...
        <p className="settings-page__subtitle">
          Manage your account and doctor profile preferences.
        </p>
      </div>
